...
import { maggie,maggieCredentials, curranFarms, testPlacemarks } from "../fixtures.js";
...
suite("Placemark API tests", () => {
  ...
  test("create placemark", async () => {
    const returnedPlacemark = await placemarkService.createPlacemark(curranFarms);
    assert.isNotNull(returnedPlacemark);
    assertSubset(curranFarms, returnedPlacemark);
  });
  test("delete a placemark", async () => {
    const placemark = await placemarkService.createPlacemark(curranFarms);
